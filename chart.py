...
endDate = pd.Timestamp(year=2012,month=1,day=1)
...
for ticker in tickers:
    ...
    for i in [1,2,3,4]:
        pattern = Strategy.trend(data['Close'],numIters=i,direction='up',ax=ax,plotOpt=True)
        print((i,pattern))
    data['BB'] = Strategy.bollingerBands(data,window=20,avgType='simple',ax=None,plotOpt=True)
