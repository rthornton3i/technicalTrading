...
class Backtest:
    ...
    def exploration(self, **kwargs):
        ...
        for stdev in kwargs['stdev']:
            ...
            self.data['MACD_avg'] = Strategy.avgPrice(
            ...
            self.data['BB'] = Strategy.bollingerBands(self.data['ATR'],
                                                      window=125,
                                                      avgType='median')
    ...
    def strategy(self, runNull=False):
        ...
        #                                         self.info['sma'])
        indicator['MACD'] = Indicators.MACD_Delta(self.data,self.info)
        indicator['ATR'] = Indicators.ATR_BB(self.data)
